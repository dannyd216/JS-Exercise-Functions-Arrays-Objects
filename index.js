...
function makeSmartPerson(personName) {
  ...
  //return Object --> ie makeSmart because makeSmart is a instance of the object
  return makeSmart;
 ...
 * it will return `This is a Lincoln Navigator`.
 */
function getCarInfoById(someArray, someNum) {
  /* code here */

  return `This is a ${someArray[someNum - 1].car_make} ${someArray[someNum - 1].car_model}`;
}
 ...
 */
function sortCarInventory(myArray) {
  /* code here */
